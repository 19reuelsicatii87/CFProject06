							...
							<ul class="navbar-nav ms-5 mb-2 mb-lg-0">
								<li class="nav-item dropdown">
									...
									<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
										...
										<li>
											<a
												href  ="https://ortussolutions.atlassian.net/browse/COLDBOX"
												class ="dropdown-item"
												target="_blank"
											>
												<i class="bi bi-bug"></i> Report a Bug - test02
											</a>
										</li>
										<li>
											<a
												href  ="http://patreon.com/ortussolutions"
												class ="dropdown-item"
												target="_blank"
											>
										...
										<li class="p-2">
											<img
												...
												width="150"
												src  ="includes/images/ColdBoxLogo2015_300.png"
												alt  ="logo"
											/>
										</li>
									</ul>
								...
								<li class="nav-item dropdown">
									...
									<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
										<li>
											<a
												class ="dropdown-item"
												href  ="https://www.ortussolutions.com/blog"
												target="_blank"
											>Blog</a>
										</li>
										<li>
										...
										<li>
											<a
												class ="dropdown-item"
												href  ="https://www.ortussolutions.com/services/training"
												target="_blank"
											>Courses</a>
										</li>
										<li>
											<a
												class ="dropdown-item"
												href  ="https://coldbox.ortusbooks.com"
												target="_blank"
											>Documentation</a>
										</li>
									</ul>
								...
								<li class="nav-item dropdown">
									...
									<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
										...
										<li>
											<a
												class="dropdown-item"
												href ="https://community.ortussolutions.com/c/communities/coldbox/13"
											>Mailing List</a>
										</li>
										<li>
