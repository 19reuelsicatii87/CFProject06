...
component {
	...
	function configure(){
		...
		// @app_routes@
		//route( "/aboutus" ).as( "aboutus" ).to( "aboutus.index" );
		route("/messages/edit/:id").to("messages.edit");
		route("/contactus/update/:id").to("contactus.update");

		route( "/api/private" ).to( "api.private.index" );
