<cfoutput>
							...
							<div class="mb-3">
								<div class="input-group mb-3">
									...
									<input
										...
										value="#htmlEditFormat(prc.message.fullname)#"
									>
								...
								<div class="input-group mb-3">
									...
									<input
										...
										class="form-control"
										aria-describedby="emailHelp"
										value="#htmlEditFormat(prc.message.email)#"
									>
								...
								<div class="input-group mb-0 pb-0">
									...
									<input
										...
										class="form-control"
										aria-describedby="emailHelp"
										value="#htmlEditFormat(prc.message.number)#"
									>
								...
								<div class="input-group mb-3">
									...
									<textarea
										...
										class = "form-control"
										rows = "6"
									>#htmlEditFormat(prc.message.message)#</textarea>
								</div>
							</div>
							<button id="contactusUpdateButton" type="submit" class="btn btn-primary btn-lg w-100"
								onclick="contactusUpdate(event, '#event.buildLink( "contactus/update/" & prc.message.id )#')" disabled>Submit</button>
						</div>
					</div>
				</form>
			</div>
	...
	<script>
		...
		function contactusUpdate(event, url) {
			...
			formData.append('id', #prc.message.id#);
    ...
    const submitButton = document.getElementById('contactusUpdateButton');
