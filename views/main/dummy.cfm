	...
	<div class="container mb-5">
		<div class="row py-5 row-cols-lg-2 gx-4">
			<div class="col d-flex align-items-start">
				<div
					class="bg-light text-blue flex-shrink-0 me-3 px-2 fs-2 rounded-circle shadow-sm border border-5 border-white"
				>
				...
				<div>
					...
					<div class="list-group">
						<cfloop list="#getSetting( "RegisteredHandlers" )#" index="handler">
							<a
								href ="#event.buildLink( handler )#"
								class="list-group-item list-group-item-action d-flex gap-2 py-3"
								title="Run Event"
							>
				...
				<div>
					...
					<div class="list-group">
						<cfloop collection="#getSetting( "Modules" )#" item="thisModule">
							<a
								href ="#event.buildLink( getModuleConfig( thisModule ).inheritedEntryPoint )#"
								class="list-group-item list-group-item-action d-flex gap-2 py-3"
								title="Run Event"
							>
								<div class="rounded-circle flex-shrink-0 text-success px-1">
		...
		<div class="row pb-5 row-cols-lg-2 gx-4">
			<div class="col d-flex align-items-start">
				<div
					class="bg-light text-blue flex-shrink-0 me-3 px-2 fs-2 rounded-circle shadow-sm border border-3 border-white"
				>
